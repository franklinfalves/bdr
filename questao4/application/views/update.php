...
<div class="container">
  ...
  <form action="http://localhost/bdr/questao4/index.php/action/update/<?php echo $value->id;?>" name="form" method="post">
    ...
    <div class="form-group">
      ...
      <input type="description" class="form-control" id="description" placeholder="Enter Description" name="description" value="<?php echo $value->description;?>">
    </div>
    <div class="form-group">
